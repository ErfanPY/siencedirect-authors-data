...
DROP DATABASE IF EXISTS `sciencedirect`;
...
CREATE TABLE IF NOT EXISTS `articles` (
  ...
  `keywords` VARCHAR(2083) DEFAULT NULL,
...
-- Dumping structure for table sciencedirect.searchs
...
-- Dumping structure for table sciencedirect.search_articles
DROP TABLE IF EXISTS `search_articles`;
